<?php
	class super_encryptor{
		...
		public function mekpieces($text, $chunks = 3, $fill = '') {
			$outtxt = [];
		...
		public function encryptme($m, $offset = null, $salt = '', $chunks = 1) {
			// Default values
			$salt = $salt === null ? '' : $salt;
		...
		public function decryptme($m, $offset = null, $salt = '') {
